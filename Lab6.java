...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		//nose
		gl2.glPushMatrix();
		gl2.glTranslated(0,1,1.8);
		gl2.glScaled(1, 1, 1);
		mat(3,gl2);
		glut.glutSolidSphere( 0.70, 32, 32 );
		gl2.glPopMatrix();
		
		//left eye
		gl2.glPushMatrix();
		gl2.glTranslated(-1,2,1.8);
		gl2.glScaled(0.50, 0.50, 0.50);
		mat(6,gl2);
		glut.glutSolidSphere( 0.70, 32, 32 );
		gl2.glPopMatrix();
		...
		//hat
		gl2.glPushMatrix();
		gl2.glTranslated(0,2.50,0);
		gl2.glRotatef(-90,1,0,0);
		mat(8,gl2);
		glut.glutSolidCone( 1.50, 3, 60, 10 );
		gl2.glPopMatrix();
